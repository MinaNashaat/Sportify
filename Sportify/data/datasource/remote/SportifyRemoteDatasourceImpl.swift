...
class SportifyRemoteDataSourceImpl: SportifyRemoteDataSourceProtocol {
    ...
    func getLeagues(
        ...
        try await apiService.request(
            endpoint: SportifyEndpoints.leagues(
                sport: sport
            )
        )
    }
    ...
    func getLiveMatches(
        ...
        try await apiService.request(
            endpoint: SportifyEndpoints.liveScore(
                sport: sport
            )
        )
    }
    ...
    func getLeagueEvents(
        ...
        try await apiService.request(
            endpoint: SportifyEndpoints.leagueEvents(
                sport: sport,
                leagueId: leagueId,
                from: from,
                to: to
    ...
    func getTeamEvents(
        ...
        try await apiService.request(
            endpoint: SportifyEndpoints.teamEvents(
                sport: sport,
                leagueId: leagueId,
                teamId: teamId,
                from: from,
    ...
    func getLeagueTeams(
        ...
        try await apiService.request(
            endpoint: SportifyEndpoints.leagueTeams(
                sport: sport,
                leagueId: leagueId
            )
        )
